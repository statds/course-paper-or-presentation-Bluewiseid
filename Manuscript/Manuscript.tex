...
This paragraph just put an ReLu function outside of the layers and that is the activation function of the layer to ensure to produce the real probability. We have a variaty of activation functions to choose, including 
...
\section*{Discussion}
If you merge the code above with this line of code below, 
